...
const BLOCKS_FILTER = 'fieldify_blocks';
...
add_filter( 'block_categories_all', __NAMESPACE__ . '\\register_categories' );
/**
 ...
 * @return array
 */
function register_categories( array $block_categories ): array {
	$blocks = get_blocks();
...
function get_blocks(): array {
	$blocks = apply_filters( BLOCKS_FILTER, [] );
